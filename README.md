...
└── modules/
    ├── app-service/      # azurerm_linux_web_app — see modules/app-service/README.md
    ├── container/         # azurerm_container_group — see modules/container/README.md
    ├── function-app/      # azurerm_linux_function_app — see modules/function-app/README.md
    ├── network/            # VNet + subnets + NSG — see modules/network/README.md
    └── storage/            # Storage Account + containers — see modules/storage/README.md
```

Each module's `README.md` (inputs, outputs, resources) is auto-generated by [terraform-docs](https://terraform-docs.io) — see [`.terraform-docs.yml`](.terraform-docs.yml). It regenerates automatically on commit via the `terraform_docs` pre-commit hook, so it never drifts from the code.
